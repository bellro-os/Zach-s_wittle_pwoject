...
export function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        // Ratified card: rounded-2xl, white/10 border, ink-900/80 surface.
        "bg-ink-900/80 text-(--color-card-foreground) flex flex-col gap-6 rounded-2xl border border-white/10 py-6",
        className,
      )}
      {...props}
    />
