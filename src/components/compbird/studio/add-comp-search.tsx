    ...
    <div ref={rootRef} className="relative">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="font-data w-full rounded-xl border border-border bg-card/70 py-2.5 pl-10 pr-10 text-sm text-foreground outline-none transition-colors placeholder:font-sans placeholder:text-muted-foreground focus:border-[var(--cb-ember)] focus:ring-2 focus:ring-[var(--cb-ember)]/25 disabled:cursor-not-allowed disabled:opacity-50"
        />
        {loading || busy ? (
